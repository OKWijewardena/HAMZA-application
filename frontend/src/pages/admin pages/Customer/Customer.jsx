    ...
    return(
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Box component="form" sx={{ mt: 1 }}>
          ...
          <TextField margin="normal" required fullWidth label="Second Mobile Number" />
          <TextField margin="normal" required fullWidth label="Civil ID" />
          <TextField margin="normal" required fullWidth label="Paci Number" />
          ...
          <Table sx={{ minWidth: 650 }}>
            <TableHead>
              <TableRow>
                ...
                <TableCell>2nd Mobile</TableCell>

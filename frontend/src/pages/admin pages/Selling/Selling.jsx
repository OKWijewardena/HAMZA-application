    ...
    return(
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Box component="form" sx={{ mt: 1 }}>
          ...
          <TextField margin="normal" required fullWidth label="Customer Name" />
          <TextField margin="normal" required fullWidth label="Civil ID" />
          <TextField margin="normal" required fullWidth label="Price" />
          <TextField margin="normal" required fullWidth label="Month" />
          <TextField margin="normal" required fullWidth label="Date" type="date"/>
          <TextField margin="normal" required fullWidth label="Advance" />
          <Button
            type="submit"
            fullWidth
            variant="contained"
